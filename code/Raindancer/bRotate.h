...
public:
	...
	virtual void onInitialize(Blackboard& bb) {
      ...
      bb.flagForceRotateDirection = FRD_CC;   //The initial defaut direction to be sure something is set if flagBumperActivatedRight and left are false
      bb.driveDirection = DD_FEOROTATECC;  //The initial defaut direction to be sure something is set
