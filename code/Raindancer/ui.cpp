...
void cmd_hideShowing(int arg_cnt, char **args) {
	...
	perimeterSensoren.showCorrelation('L', false);
	perimeterSensoren.showCorrelation('R', false);

	perimeterSensoren.showCorrelationSQ('L', false);
	perimeterSensoren.showCorrelationSQ('R', false);

	perimeterSensoren.showPSNRFunction('L', false);
	perimeterSensoren.showPSNRFunction('R', false);

	perimeterSensoren.showValuesResults('L', false);
	perimeterSensoren.showValuesResults('R', false);
