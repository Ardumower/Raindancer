...
#define RAINDANCER_CHASSIS_BLDC false
...
//======================================================================================================================
#if RAINDANCER_CHASSIS_BLDC == true
...
#define CONF_USE_BLDC_DRIVER            true   // Use Bldc drivers like BLDC-8015A or BLD-300B

#define CONF_ENCTICKSPERREVOLUTION		1245.0f // Count of positive encoder flanks per one revolution at the DUE pin!!!
...
#define  CONF_CLC_DEFAULT_KFR   0.9f    // CLC PDFF regulator
#define  CONF_CLC_DEFAULT_KP    3.0f
#define  CONF_CLC_DEFAULT_KI    7.0f
#define  CONF_CLC_PER_KFR       0.45f
#define  CONF_CLC_PER_KP        4.0f
#define  CONF_CLC_PER_KI        8.0f
#define  CONF_CLC_FSTOP_KFR        0.45f
#define  CONF_CLC_FSTOP_KP         4.0f
#define  CONF_CLC_FSTOP_KI         8.0f
...
#define CONF_CHARGING_STATION_GRIND_CONTACTS true //the mower can go through the station and will grind the contacts while moving forward and backwards. 
#define CONF_LEAVE_CHARGING_STATION_BACKWARDS  false // decide if you want to leafe charging station backwards while using the area command. 
...
#endif // #if RAINDANCER_CHASSIS_BLDC == true
//======================================================================================================================
...
#define CONF_USE_BLDC_DRIVER            false   // Use Bldc drivers like BLDC-8015A or BLD-300B
...
#define  CONF_CLC_DEFAULT_KFR   1.0f    // CLC PDFF regulator
#define  CONF_CLC_DEFAULT_KP    7.0f
#define  CONF_CLC_DEFAULT_KI    8.0f
#define  CONF_CLC_PER_KFR       0.45f
#define  CONF_CLC_PER_KP        6.0f
#define  CONF_CLC_PER_KI        8.0f
#define  CONF_CLC_FSTOP_KFR        0.4f
#define  CONF_CLC_FSTOP_KP         4.0f
#define  CONF_CLC_FSTOP_KI         8.0f
